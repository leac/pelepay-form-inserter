 ...
 * @subpackage Pelepay_Form_Inserter/includes
 */
...
class Pelepay_Form_Inserter {
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pelepay-form-inserter-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pelepay-form-inserter-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the Dashboard.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pelepay-form-inserter-admin.php';

        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-pelepay-form-inserter-public.php';

        $this->loader = new Pelepay_Form_Inserter_Loader();
    }
    ...
    private function set_locale() {
        ...
        $plugin_i18n = new Pelepay_form_inserter_i18n();
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'admin_footer', $plugin_admin, 'principles_pages_list' );
        $this->loader->add_action( 'wp_ajax_principles_pages_list', $plugin_admin, 'principles_pages_list_ajax' );
    }
    ...
    private function define_public_hooks() {
        ...
        $plugin_public = new Pelepay_Form_Inserter_Public( $this->get_plugin_name(), $this->get_version() );
